  ...
  <div className="relative z-10 flex min-h-screen items-center justify-center px-4 py-20 sm:px-6 sm:py-24">
    ...
    <div className="mx-auto max-w-5xl text-center">
      ...
      <motion.p
        ...
        "
      >
        Take a look at some of our recent tree removal,
        trimming, stump grinding, and emergency tree service
        projects completed throughout Michigan and surrounding
        communities.
      </motion.p>
  ...
  <div className="max-w-6xl mx-auto px-4 sm:px-6">
    ...
    >
      ...
      <p className="mt-4 max-w-2xl mx-auto text-sm sm:text-base text-gray-600">
        Years of experience delivering professional tree care
...
{/* CATEGORY FILTERS */}
<section className="py-10 sm:py-12 bg-gradient-to-b from-green-50 to-white">
  <div className="max-w-6xl mx-auto px-4 sm:px-6">
  ...
  <div className="max-w-6xl mx-auto px-4 sm:px-6">
    ...
    >
      ...
      <p
        ...
        "
      >
        Browse through our portfolio of successfully completed
        tree care projects.
      </p>
  ...
  <div className="max-w-6xl mx-auto px-4 sm:px-6">
    ...
    >
      ...
      <p
        ...
        "
      >
        Watch our professional tree care team in action
        with these project videos.
      </p>
    ...
    >
      ...
      >
        ...
        <p className="text-gray-600 text-sm sm:text-base">
          {spotlightProject.timeCompleted}
        </p>
...
Whether you need tree removal, trimming, stump grinding, or emergency service, our experienced team is ready to help.
